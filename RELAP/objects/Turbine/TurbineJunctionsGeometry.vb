<System.Serializable()> Public Class TurbineJunctionsGeometry
    ...
    Protected m_collection As Generic.SortedDictionary(Of Integer, TurbineGeometry)
    ' Protected m_status As PipeEditorStatus = PipeEditorStatus.Definir

    Public Property TurbineGeometry() As Generic.SortedDictionary(Of Integer, TurbineGeometry)
        Get
            Return m_collection
        End Get
        Set(ByVal value As Generic.SortedDictionary(Of Integer, TurbineGeometry))
            m_collection = value
        End Set
    End Property
    ...
    Public Sub New()
        m_collection = New Generic.SortedDictionary(Of Integer, TurbineGeometry)
...
End Class
<System.Serializable()> Public Class TurbineGeometry
    ...
    Public Sub New(ByVal FromComponent As String, ByVal FromComponentVolumeNumber As Double, ByVal FromFaceNumber As String, ByVal ToComponent As String, ByVal ToComponentVolumeNumber As Double, ByVal ToFaceNumber As String, ByVal JunctionArea As Double, ByVal FFLossCo As Double, ByVal RFlossCo As Double, _
                    ByVal LiquidMassFlow As Double, ByVal VaporMassFlow As Double)
