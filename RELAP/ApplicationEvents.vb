Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Private Sub MyApplication_Startup(ByVal sender As Object, ByVal e As Microsoft.VisualBasic.ApplicationServices.StartupEventArgs) Handles Me.Startup
            ...
            ''       _ResourceManager = New System.Resources.ResourceManager("RELAP", System.Reflection.Assembly.GetExecutingAssembly())

            'loads the help manager
            ''      _HelpManager = New System.Resources.ResourceManager("RELAP.Help", System.Reflection.Assembly.GetExecutingAssembly())

            'loads the property name manager
            ''     _PropertyNameManager = New System.Resources.ResourceManager("RELAP.Properties", System.Reflection.Assembly.GetExecutingAssembly())
