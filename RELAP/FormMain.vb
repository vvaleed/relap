    ...
    Private Sub GenerateInputFileToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GenerateInputFileOnlyToolStripMenuItem.Click
        ...
        If SaveFileDialog1.ShowDialog() = DialogResult.OK Then
            ...
            For Each kvp As KeyValuePair(Of String, RELAP.SimulationObjects.UnitOps.SingleJunction) In ChildParent.Collections.CLCS_SingleJunctionCollection
                ...
                output = kvp.Value.UID & "0101 " & kvp.Value.FromComponent & kvp.Value.FromVolume & "000" & kvp.Value.FromDirection & " " & kvp.Value.ToComponent & kvp.Value.ToVolume & "000" & kvp.Value.ToDirection & " " & " " & kvp.Value.JunctionArea & " " & kvp.Value.FflowLossCo & " " & kvp.Value.RflowLossCo & " " & "0000100" & " " & kvp.Value.SubcooledDishargeCo & " " & kvp.Value.TwoPhaseDischargeCo & " " & kvp.Value.SuperheatedDishargeCo
                generate.WriteLine(output)
            ...
            For Each kvp As KeyValuePair(Of String, RELAP.SimulationObjects.UnitOps.pipe) In ChildParent.Collections.CLCS_PipeCollection
                ...
                For Each kvp2 As KeyValuePair(Of Integer, PipeJunctions) In kvp.Value.Profile.Junctions
                    ...
                    End If
                    output = kvp.Value.UID & "130" & counter & " " & output1 & " " & kvp2.Value.InterphaseVelocity
                    generate.WriteLine(output)
                    counter = counter + 1
                Next kvp2
            Next kvp
