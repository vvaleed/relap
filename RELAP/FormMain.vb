    ...
    Private Sub GenerateInputFileToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GenerateInputFileOnlyToolStripMenuItem.Click
        ...
        If SaveFileDialog1.ShowDialog() = DialogResult.OK Then
            ...
            For Each kvp As KeyValuePair(Of String, RELAP.SimulationObjects.UnitOps.SingleJunction) In ChildParent.Collections.CLCS_SingleJunctionCollection
                ...
                output = kvp.Value.UID & "0101 " & kvp.Value.FromComponent & CDbl(kvp.Value.FromVolume).ToString("D2") & "000" & kvp.Value.FromDirection & " " & kvp.Value.ToComponent & CDbl(kvp.Value.ToVolume).ToString("D2") & "000" & kvp.Value.ToDirection & " " & " " & kvp.Value.JunctionArea & " " & kvp.Value.FflowLossCo & " " & kvp.Value.RflowLossCo & " " & "0000100" & " " & kvp.Value.SubcooledDishargeCo & " " & kvp.Value.TwoPhaseDischargeCo & " " & kvp.Value.SuperheatedDishargeCo
                generate.WriteLine(output)
