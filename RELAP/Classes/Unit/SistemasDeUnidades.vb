...
Namespace RELAP.SistemasDeUnidades
    ...
    '            .nome = RELAP.App.GetLocalString("Personalizado1BR")
    ...
    '            .nome = RELAP.App.GetLocalString("Personalizado2SC")
    ...
    '            .nome = RELAP.App.GetLocalString("Personalizado3CNTP")
    ...
    '            .nome = RELAP.App.GetLocalString("Personalizado4")
    ...
    <System.Serializable()> Public Class UnidadesINGLES
        ...
        Public Sub New()
            ...
            With Me
                ...
                .nome = RELAP.App.GetLocalString("SistemaIngls")
                .angle = "deg"
                .accel = "ft/s2"
                .area = "ft2"
                .diameter = "in"
    ...
    '            .nome = RELAP.App.GetLocalString("SistemaCGS")
