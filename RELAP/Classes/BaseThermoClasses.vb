'    Basic Thermodynamic Classes for RELAP
'    
'
...
Imports System.IO
'Imports RELAP.RELAP.SimulationObjects.Streams

Namespace RELAP.ClassesBasicasTermodinamica
    ...
    Public Class Reaction
        ...
        Protected m_reactionheat As Double
        Protected m_reactionheatCO As Double
        Protected m_stoichbalance As Double
...
#End Region
        ...
        '        Protected m_params As CapeOpen.CParameterCollection
        ...
        '                m_params = New CapeOpen.CParameterCollection
        '                'm_params.Add(...)
        '            End If
        '        End Sub
...
#Region "Subclasses"
    ...
    <System.Serializable()> <XmlRoot(ElementName:="Component")> Public Class ConstantProperties
        ...
        'Databases: 'RELAP', 'CheResources', 'ChemSep' OR 'User'
        'User databases are XML-serialized versions of this base class, and they may include hypos and pseudos.
        Public OriginalDB As String = "RELAP"
        Public CurrentDB As String = "RELAP"
